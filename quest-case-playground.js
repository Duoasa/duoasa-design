...
function revealQuestFallback() {
  ...
  document.querySelectorAll(".highlight-ui-half img").forEach((item) => {
    item.style.opacity = "1";
    item.style.transform = "none";
  });
}
...
function initQuestAnimations() {
  ...
  gsap.set(".highlight-ui-half img", { opacity: 1, yPercent: 42 });
  ...
  function initQuestScrollAnimations() {
    ...
    gsap.utils.toArray(".highlight-ui-half img").forEach((item) => {
